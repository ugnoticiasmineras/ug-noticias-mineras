...
export default function SearchPage({ allNews, currentDate }) {
  ...
  return (
    <Layout currentDate={currentDate}>
      <Head>
        <title>{q ? `Resultados para "${q}"` : 'Buscar Noticias'} - UG Noticias Mineras</title>
        <meta name="description" content="Busca noticias mineras por palabra clave." />
        <meta property="og:title" content={q ? `Resultados para "${q}"` : 'Buscar Noticias'} />
        <meta property="og:description" content="Busca noticias mineras por palabra clave." />
        <meta property="og:image" content="/logo.png" />
        <meta property="og:url" content={`${SITE_URL}/noticia/buscar`} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="p-6">
              {paginatedNews.length > 0 ? (
                ...
                <div className="text-center py-12 text-gray-600 dark:text-gray-400">
                  {q ? `No se encontraron noticias con "${q}".` : 'Ingresa una palabra en la lupa del sidebar.'}
                </div>
              )}
        ...
        <div className="lg:col-span-1">
          ...
          {/* Aquí podrías agregar un campo de búsqueda si lo deseas, pero no es necesario */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-blue-100 dark:border-blue-900 overflow-hidden mb-4 p-4 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Usa la lupa en el home para buscar.
            </p>
          </div>
